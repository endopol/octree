...
double& OctreePoint::getLocation(int i) { return location[i]; }

double& OctreePoint::getNomLocation(int i) { return nom_location[i]; }

int OctreePoint::getDepth() const { return depth; }
